...
// Scanner + StringBuilder.reverse() 사용
/*
...
public class Problem_2908 {
	...
	public static void main(String[] args) {
		...
		numA = Integer.parseInt(new StringBuilder().append(numA).reverse().toString());
		numB = Integer.parseInt(new StringBuilder().append(numB).reverse().toString());
		
		System.out.println(numA > numB ? numA : numB); // 3항 연산
